...
let addPurple = colorCopy.push('purple')
...
const me = {
   ...
   state: 'Utah',
	age: 21,
	greeter: function sayHi(firstName,state){
...
let forTheLoveOfGeorge = notGeorge(function(element){
	return element ['George', 'George', 'George', 'George', 'George', 'George']
})
